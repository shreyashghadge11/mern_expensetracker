...
const Transaction=({month,year,expense,deleteexpense,addexpense,updateexpense})=>{
    ...
    return(
        ...
        <div>
        {expense.transactions && expense.transactions.map(item =>{
            return(
                ...
                <Card.Body>
                    ...
                    <Button variant="warning mx-2" onClick={()=>handleEdit(item.description,item.amount,item._id)}>Edit</Button>
                    <Button variant="danger" onClick={()=>iddelete(item._id)}>Delete</Button>
                </Card.Body>
                </Card> )
        ...
        {(edit)?
            ...
            <Form onSubmit={(e)=>handleSubmit(e)}>
                <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Control type="text" name="description" onChange={(e)=>handlechange2(e)} placeholder="Enter description" defaultValue={data.description}/>
                    
                </Form.Group>

                <Form.Group controlId="formBasicPassword">
                    <Form.Label>Amount</Form.Label>
                    <Form.Control type="number" name="amount" onChange={(e)=>handlechange(e)} placeholder="Amount" defaultValue={data.amount} />
                </Form.Group>
...
const Add = ({month,year,addexpense}) =>{
    ...
    const handleSubmit = e =>{
        e.preventDefault();
        var newexpense={
            description:des,amount:amt,month:month,year:year
        }
    ...
    return(
        <div>
            ...
            <Form onSubmit={(e)=>handleSubmit(e)}>
                <Form.Group controlId="formBasicEmail">
                    <Form.Label>Description</Form.Label>
                    <Form.Control type="text" name="description" onChange={(e)=>handlechangedes(e)} placeholder="Enter description" />
                    
                </Form.Group>

                <Form.Group controlId="formBasicPassword">
                    <Form.Label>Amount</Form.Label>
                    <Form.Control type="number" name="amount" onChange={(e)=>handlechange(e)} placeholder="Amount" />
                </Form.Group>
